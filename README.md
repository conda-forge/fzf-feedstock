...
Development: https://github.com/junegunn/fzf
...
It is possible to list all of the versions of `fzf` available on your platform:
...
```
pixi search fzf --channel conda-forge
```
